...
#ifndef LAB2_ARRAYITERATOR_H
#define LAB2_ARRAYITERATOR_H
...
public:
    ...
    explicit ArraySequenceIterator(elem_ptr_t elem): elem_(elem) {};

    template<bool other_const>
    explicit ArraySequenceIterator(const ArraySequenceIterator<T, other_const>& o) noexcept
    {
        static_assert(is_const >= other_const, "Invalid constness");
        elem_ = o.elem_;
    }

    template<bool other_const>
    ArraySequenceIterator& operator =(const ArraySequenceIterator<T, other_const>& o) noexcept
    {
        static_assert(is_const >= other_const, "Cannot assign from a const iterator to a non-const iterator.");
        elem_ = o.elem_;
        return *this;
    }
